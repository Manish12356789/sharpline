            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="widget widget_about">
                        <div class="logo-footer"><img src="images/sharpline_white.png" alt=""></div>
                        <p class="m-t40"><strong>Sharpline</strong> Lorem ipsum dolor sit amet, cons ectetur elit. Vestibulum nec odios Suspe ndisse cursus. cons ectetur elit. Vestibulum nec odios Lorem ipsum dolor sit amet, cons ectetur elit.
                            Vestibulum nec.</p>
        ...
        <div class="container">
            <div class="row text-white">
                <div class="col-lg-4 col-md-4 text-left">
                    <span>Copyright © 2020 Sharpline</span>
                </div>
                <div class="col-lg-4 col-md-4 text-center">
                    <span> Designed By <a href="https://nextaussietech.com" target="_blank">NAT</a></span>
                </div>
