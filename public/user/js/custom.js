 ...
 * @Date:   07-Feb-2020 11-13-23 AM
 * @Email:  nepal.satish@hotmail.com
 * @Last modified by:   satish
 * @Last modified time: 10-Feb-2020 12-23-35 PM
...
var Clean360 = function(){
	...
	var dzTheme = function(){
		...
		if(screenWidth <= 991)
		{
			if($('.mo-left .header-nav').children('.logo-header').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','images/sharpline.png');
	...
	var fileInput = function(){
		...
		jQuery(document).on('change', '.btn-file :file', function() {
			...
			var	label = input.val().replace(/\\/g, 'https://clean360.dexignlab.com/').replace(/.*\//, '');
